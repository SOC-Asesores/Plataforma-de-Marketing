...
<html lang="en">
  ...
  <div class="tarjeta">
                            <div class="tarjeta_header">
                                <img src="https://i.ibb.co/pfkC4yv/SOC1-300x-1.png" alt="">
                            </div>
                            ...
                            <div class="tarjeta_description">
                                <h1>{{$registro->name}}</h1>
                                <h2 style="color: #80B27F">{{$registro->puesto}}</h2>
                            ...
                            <div class="tarjeta_social">
                                <ul>
									...
									@if($registro->tiktok != null)
										<li><a target="_blank" href="{{$registro->twitter}}"><img width="32" src="https://marketing.socasesores.com/img/tiktok-logo.png" alt=""></a></li>
									@endif
                                </ul>
                            </div>
                            <div class="tarjeta_footer">
                                <p style="margin-bottom: 0"><a href="https://socasesores.com/" target="_blank">socasesores.com</a></p>
