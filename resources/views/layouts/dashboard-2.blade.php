  ...
  <body>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <form class="form-inline ml-4" method="post" action="{{ route('export2') }}">
              @csrf
      ...
      <div class="row">
        <div class="col-12">
          <ul class="d-inline-block" style="list-style: none;">
            ...
            <li class="d-inline-block mr-4"><a class="btn btn-primary" href="{{ route("dashboard2") }}">Carpetas</a></li>
      ...
      <div class="row">
        ...
        <div class="col-12">
          @if(Route::is('searchFolders'))

          @elseif(Route::is('export2'))
