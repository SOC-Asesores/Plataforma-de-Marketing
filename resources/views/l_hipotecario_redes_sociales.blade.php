...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Hipotecario - Redes Sociales</h2>
                </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_post_facebook" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_post_instagram" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Post de Instagram
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_post_twitter" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Post de Twitter
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_post_linkedin" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Post de Linkedin
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_post_tiktok" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Post de Tik Tok
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_infografias" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Infografías
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_frases" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Frases
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_diario" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                ABCDario Financiero
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_promocion" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_portadas" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Portadas
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_hipotecario_camapana_publicidad" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
