    ...
    <div class="container">
            ...
            <div class="row">
                ...
                @foreach($folders_inter as $folder_inter)
                    @if($folder_inter->slug == "directorio-soc-256794157" && $contador_herramientas === 0)
                                <div class="col-md-4">
...
<section class="registro-section hide">
    ...
    @empty($registros)
        ...
        <a class="download" data-id="" href="" files="[]" base="{{ url('archivos') }}/" download><i class="fas fa-cloud-download-alt"></i></i> Descargar</a>
        <div class="dropdown">
          <button class="dropbtn"><i class="fas fa-share"></i>Compartir</button>
          <div class="dropdown-content">
