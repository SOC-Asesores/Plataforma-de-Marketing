        ...
        <div class="container-fluid">
            <div class="row tarjetas-form align-items-center">
                <div class="col-md-3 flex-shrink-1">
                    <div class="row">
                        <ul>
                            ...
                            <li><a href="{{url('/')}}/identidad_firma" class="active">Firma de correo</a></li>
                ...
                <div class="col-md-5">
                    ...
                    <form action="{{route('sendIdentidadFirma')}}" method="post">
                        @csrf
                        ...
                        <label for="">Nombre de la oficina</label>
                        <input type="text" placeholder="Ej. Soc Asesores" name="oficina" required>
                        <label for="">Micrositio Oficina</label>
                        <input type="text" placeholder="Ej. socasesores.com/oficina/becerra-guanajuato" name="micrositio_oficina">
                      ...
                      <!-- <p>Redes Sociales</p>
                        ...
                        <input type="submit" value="Crear firma de correo" placeholder="Generar firma">
                    </form>
                </div>
                <div class="col-md-4 d-flex justify-content-center flex-column">
                    <h1 class="text-center">Mi nueva firma de correo</h1>
                    @isset($url_1)
