...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Hipotecario - Redes Sociales - Campaña de publicidad</h2>
                </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_comparador_hipotecario" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_redes_sociales_somos_soc" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/redes-sociales.jpg);"></div>
                            <p class="text-center">
                                Somos SOC
                            </p>
