    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/soc_racing_hipotecario" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/soc-racing.jpg);"></div>
                            <p class="text-center">
                                SOC Racing - Hipotecario
                            </p>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/soc_racing_empresarial" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/soc-racing.jpg);"></div>
                            <p class="text-center">
                                SOC Racing - Empresarial
                            </p>
                        </a>
                    </div>
